              ...
              <main className="w-full max-w-[2560px] mx-auto pt-0">
                ...
                <section className="pb-12 px-4 sm:px-6 lg:px-8">
                  <div className="mx-auto w-full max-w-[1800px]">
                    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 md:p-8">
                      ...
                      <div className="text-base md:text-lg text-gray-700 leading-relaxed space-y-4">
                        ...
                        <ul className="space-y-2 ml-6 list-disc">
                          <li>Quý khách vui lòng thanh toán <strong className="text-blue-600">100% giá trị đơn hàng</strong> trước khi tiến hành giao hàng.</li>
                        ...
                        <p className="font-semibold text-red-600">⚠️ Lưu ý: Quý khách vui lòng kiểm tra kỹ thông tin tài khoản trước khi chuyển.</p>
                    ...
                    {/* Contact & Addresses */}
                    <div className="mt-8 bg-gray-50 rounded-xl shadow-sm border border-gray-100 p-6 md:p-8">
                      <div className="text-center mb-6">
                        <p className="text-2xl font-bold text-blue-600 mb-2">WECARE GROUP _ SIÊU THỊ CÔNG NGHIỆP</p>
                      </div>
