      ...
      <main>
          ...
          <div className="container-responsive">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="title-section text-center mb-6">Về sự hợp tác cùng Wecare Group</h2>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container-responsive">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="title-section text-center mb-6">Tại sao nên hợp tác cùng Wecare Group?</h2>
                <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-purple-500 mx-auto mb-8"></div>
              </div>
              ...
              <div className="bg-white rounded-xl p-8 shadow-md mb-8 hover:shadow-lg transition-shadow duration-300">
                <div className="flex items-start">
                  ...
                  <div className="flex-1">
                    <h3 className="text-2xl font-bold text-gray-900 mb-4">1. Năng lực & kinh nghiệm vững chắc</h3>
              ...
              <div className="bg-white rounded-xl p-8 shadow-md mb-8 hover:shadow-lg transition-shadow duration-300">
                <div className="flex items-start">
                  ...
                  <div className="flex-1">
                    <h3 className="text-2xl font-bold text-gray-900 mb-4">2. Danh mục sản phẩm đa dạng – nguồn hàng ổn định</h3>
                    <p className="text-body mb-4">
              ...
              <div className="bg-white rounded-xl p-8 shadow-md mb-8 hover:shadow-lg transition-shadow duration-300">
                <div className="flex items-start">
                  ...
                  <div className="flex-1">
                    <h3 className="text-2xl font-bold text-gray-900 mb-4">3. Chính sách hợp tác & bán hàng vượt trội</h3>
                    <p className="text-body mb-4">
              ...
              <div className="bg-white rounded-xl p-8 shadow-md mb-8 hover:shadow-lg transition-shadow duration-300">
                <div className="flex items-start">
                  ...
                  <div className="flex-1">
                    <h3 className="text-2xl font-bold text-gray-900 mb-4">4. Hậu cần – giao nhận nhanh chóng, chuyên nghiệp</h3>
                    <p className="text-body mb-4">
              ...
              <div className="bg-white rounded-xl p-8 shadow-md mb-8 hover:shadow-lg transition-shadow duration-300">
                <div className="flex items-start">
                  ...
                  <div className="flex-1">
                    <h3 className="text-2xl font-bold text-gray-900 mb-4">5. Chính sách đổi trả linh hoạt – an tâm hợp tác</h3>
                    <p className="text-body mb-4">
        ...
        <section className="py-16 bg-white">
          <div className="container-responsive">
            <div className="max-w-4xl mx-auto text-center">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Bắt đầu hợp tác cùng Wecare Group</h2>
