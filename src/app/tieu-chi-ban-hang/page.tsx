    ...
    <div className="bg-white">
      <main>
          ...
          <div className="w-full px-4 sm:px-6 lg:px-8">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-6">
                <h2 className="title-section text-center mb-3">Tiêu chí bán hàng của WeCare Group</h2>
                <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-purple-500 mx-auto mb-4"></div>
              </div>

              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
                <div>
                  <h3 className="text-2xl font-bold text-gray-900 mb-3">Cam kết với khách hàng</h3>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div className="p-5">
                  ...
                  <h3 className="text-lg font-bold text-gray-900 text-center mb-2">HÀNG CHÍNH HÃNG – NGUỒN GỐC RÕ RÀNG</h3>
                ...
                <div className="p-5">
                  ...
                  <h3 className="text-lg font-bold text-gray-900 text-center mb-2">GIÁ THÀNH CẠNH TRANH – TỐI ƯU CHI PHÍ</h3>
                  <p className="text-body text-center leading-relaxed">
                ...
                <div className="p-5">
                  ...
                  <h3 className="text-lg font-bold text-gray-900 text-center mb-2">ĐA DẠNG SẢN PHẨM CÔNG NGHIỆP</h3>
                  <p className="text-body text-center leading-relaxed">
                ...
                <div className="p-5">
                  ...
                  <h3 className="text-lg font-bold text-gray-900 text-center mb-2">TƯ VẤN NHIỆT TÌNH – ĐÚNG NHU CẦU</h3>
                  <p className="text-body text-center leading-relaxed">
                ...
                <div className="p-5">
                  ...
                  <h3 className="text-lg font-bold text-gray-900 text-center mb-2">GIAO HÀNG NHANH CHÓNG – LINH HOẠT</h3>
                  <p className="text-body text-center leading-relaxed">
                ...
                <div className="p-5">
                  ...
                  <h3 className="text-lg font-bold text-gray-900 text-center mb-2">DỊCH VỤ HẬU MÃI CHU ĐÁO</h3>
                  <p className="text-body text-center leading-relaxed">
        ...
        <section className="py-8 bg-white">
          <div className="w-full px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              <h2 className="text-3xl font-bold text-gray-900 mb-3">Liên hệ với chúng tôi ngay hôm nay</h2>
