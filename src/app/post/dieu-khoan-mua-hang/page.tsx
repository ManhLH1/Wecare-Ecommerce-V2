    ...
    <div className="bg-white">
      <main>
        ...
        <section className="relative bg-gradient-to-r from-blue-600 to-purple-700 text-white overflow-hidden">
          ...
          <div className="relative container-responsive py-12 md:py-16">
          ...
          <div className="container-responsive">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-8">
                <h2 className="title-section text-center mb-4">Điều khoản mua hàng của Wecare Group</h2>
          ...
          <div className="container-responsive">
            <div className="max-w-6xl mx-auto space-y-8">
              ...
              <div className="flex items-start">
                <div className="w-14 h-14 bg-blue-100 rounded-full flex items-center justify-center mr-5 flex-shrink-0">
                  <svg className="w-7 h-7 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" />
                  </svg>
                </div>
                <div className="flex-1">
                  <h3 className="text-xl font-bold text-gray-900 mb-3">1. Nghĩa vụ thanh toán</h3>
                    ...
                    <div className="bg-amber-50 border-l-4 border-amber-400 p-3 rounded-r-lg">
                      <div className="flex items-start">
                        <svg className="w-4 h-4 text-amber-600 mr-2.5 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {/* 2. Invoice Issuance */}
              <div className="flex items-start">
                <div className="w-14 h-14 bg-green-100 rounded-full flex items-center justify-center mr-5 flex-shrink-0">
                  <svg className="w-7 h-7 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z" />
                  </svg>
                </div>
                <div className="flex-1">
                  <h3 className="text-xl font-bold text-gray-900 mb-3">2. Xuất hóa đơn tài chính</h3>
                    <p className="text-body mb-3 leading-relaxed">
                      Wecare Group sẽ phát hành hóa đơn GTGT cho Quý khách khi đáp ứng đầy đủ các điều kiện sau:
                    </p>
                    <ul className="space-y-2 text-body mb-3 leading-relaxed">
                      <li className="flex items-start">
                        <span className="w-2 h-2 bg-green-500 rounded-full mr-2.5 mt-2 flex-shrink-0"></span>
              ...
              <div className="flex items-start">
                <div className="w-14 h-14 bg-purple-100 rounded-full flex items-center justify-center mr-5 flex-shrink-0">
                  <svg className="w-7 h-7 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                  </svg>
                </div>
                <div className="flex-1">
                  <h3 className="text-xl font-bold text-gray-900 mb-3">3. Phạm vi áp dụng</h3>
                    <p className="text-body leading-relaxed">
              ...
              {/* 4. Priority Terms */}
              <div className="flex items-start">
                <div className="w-14 h-14 bg-orange-100 rounded-full flex items-center justify-center mr-5 flex-shrink-0">
                  <svg className="w-7 h-7 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </div>
                <div className="flex-1">
                  <h3 className="text-xl font-bold text-gray-900 mb-3">4. Điều khoản ưu tiên</h3>
                    <p className="text-body mb-3 leading-relaxed">
