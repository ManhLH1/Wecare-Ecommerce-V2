...
const MobileCategoryMenu: React.FC<MobileCategoryMenuProps> = ({
  ...
  // Debug info
  console.log('MobileCategoryMenu Debug:', {
    isOpen,
  ...
  return (
    <>
      ...
      <div className={`fixed top-0 left-0 h-full w-full max-w-sm bg-white shadow-2xl z-50 transform transition-transform duration-300 ease-out flex flex-col ${
