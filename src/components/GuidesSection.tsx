        ...
        <div className="py-2">
          <div className="flex items-center gap-3 justify-between mb-3">
            <div className="flex items-center gap-3">
              <h3 className="text-cyan-600 no-underline hover:text-cyan-700 text-base md:text-lg uppercase">CẨM NANG - KINH NGHIỆM</h3>
              <span className="inline-block w-12 h-1 bg-amber-300 rounded" />
            </div>
            <Link href="/post" className="text-sm text-cyan-600 hover:text-cyan-700 no-underline font-normal" style={{ textDecoration: "none", textTransform: "none" }}>Xem tất cả</Link>
          </div>
