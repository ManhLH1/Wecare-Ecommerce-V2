     ...
     return (
        ...
        <div className="p-1 md:p-6 lg:p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 md:gap-6">
                 ...
                 <div className="grid grid-cols-4 gap-1">
                   {topRankingProducts.slice(0, 8).map((product, index) => (
                     <button
                       ...
                       className={`relative rounded-md overflow-hidden h-8 md:h-10 hover:scale-110 transition-transform duration-300 bg-gradient-to-br from-blue-50 to-indigo-50 border-2 group ${
                         currentSlide === index ? 'ring-2 ring-blue-500 shadow-lg border-blue-300' : 'border-blue-200 hover:border-blue-300 hover:shadow-md'
                       }`}
            ...
            <div className="space-y-3 bg-white rounded-xl p-2 md:p-3 shadow-md">
              <div className="flex items-center justify-between">
                <div>
