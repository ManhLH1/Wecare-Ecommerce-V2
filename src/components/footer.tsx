        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 text-gray-800 md:divide-x md:divide-gray-200">
          ...
          <div className="px-4 md:px-6">
            ...
            <div className="text-xs text-gray-700 space-y-1">
              <div className="mb-3">
                <p className="text-gray-800">Chuyên cung cấp vật tư kim khí, thiết bị điện - nước, hóa chất công nghiệp,...phục vụ hiệu quả cho cửa hàng kinh doanh và các nhà máy sản xuất.</p>
              </div>
              <div>
                <p className="font-medium text-white text-[11px] uppercase">Địa chỉ</p>
                <p>Trụ sở 1: Lô B39, Khu Công nghiệp Phú Tài, Phường Quy Nhơn Bắc, Tỉnh Gia Lai.</p>
                <p>Trụ sở 2:14-16-18-20, Đường 36, P. Bình Phú, TP.Hồ Chí Minh</p>
              </div>
              <div>
                <p className="font-medium text-gray-900 text-[11px] uppercase">Hotline</p>
                <p className="text-amber-600 font-semibold">037 833 9009 - 0934 794 477 - 0823 871 339</p>
              </div>
              <div>
          ...
          <div className="px-4 md:px-6">
            <h4 className="text-gray-900 font-semibold mb-3 uppercase text-sm tracking-wide">Kết nối với chúng tôi</h4>
            <div className="flex items-center gap-3 mb-3">
              <Link aria-label="Facebook" href="https://www.facebook.com/wecareyourproduct" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-gray-100 hover:bg-gray-200 text-gray-700 transition-colors no-underline">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M22 12.07C22 6.48 17.52 2 11.93 2 6.34 2 1.86 6.48 1.86 12.07c0 4.99 3.65 9.13 8.43 9.93v-7.03H7.9v-2.9h2.39V9.41c0-2.36 1.4-3.66 3.55-3.66 1.03 0 2.1.18 2.1.18v2.31h-1.18c-1.16 0-1.52.72-1.52 1.46v1.75h2.59l-.41 2.9h-2.18V22c4.78-.8 8.43-4.94 8.43-9.93z"/></svg>
              </Link>
              <Link aria-label="Zalo" href="https://zalo.me/3642371097976835684" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-gray-100 hover:bg-gray-200 transition-colors no-underline">
                <Image src={ZaloIcon} alt="Zalo" width={20} height={20} className="rounded-full" />
              </Link>
              <Link aria-label="TikTok" href="https://www.tiktok.com/@wecaresieuthicongnghiep?_t=ZS-8zYG0SMLRxQ&_r=1" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-gray-100 hover:bg-gray-200 text-gray-700 transition-colors no-underline">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M16.5 3.5c.7 1.6 2.1 2.8 3.8 3.2v3.1c-1.7 0-3.3-.6-4.6-1.6v6.8c0 3.6-2.9 6.5-6.5 6.5S2.7 18.6 2.7 15s2.9-6.5 6.5-6.5c.4 0 .7 0 1.1.1v3.2c-.3-.1-.7-.2-1.1-.2-1.8 0-3.3 1.5-3.3 3.3S7.4 18.2 9.2 18.2s3.3-1.5 3.3-3.3V2.5h4z"/></svg>
              </Link>
            </div>
            <div className="mb-2">
              ...
              <div key={name} className="h-24 w-48 flex items-center justify-center">
                    <img
